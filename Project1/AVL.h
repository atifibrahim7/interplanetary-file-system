...
public:
    ...
    AvlNode<T>* insert(int x,int num,string f, AvlNode<T>* t)
    {
        if (t == NULL)
        {
            t = new AvlNode<T>;
        ...
        {
            t->right = insert(x,num,f, t->right);
    ...
    AvlNode<T>* deleteNode(int x, AvlNode<T>* t)
    {
        AvlNode<T>* temp;
    ...
    int returnLinenumber(int x, AvlNode<T>* t)
    {
        AvlNode<T>* temp;
    ...
    int returnNum(int x)
    {
         return returnLinenumber(x, root);
    }


    string returnfilename(int x, AvlNode<T>* t)
    {
        AvlNode<T>* temp;
    ...
    string returnfile(int x)
    {
        return returnfilename(x, root);
    }
    ...
    void inorder(AvlNode<T>* t)
    {
        if (t == NULL)
            return;
        inorder(t->left);
        cout << t->data << " " << t->LineNumber <<"  "<< t->filepath << " | ";
        inorder(t->right);
    }

    void container(AvlNode<T>* t, AD<int> *y)
    {
        if (t == NULL)
            return ;
        container(t->left,y);
        y->push_roll(t->data,t->LineNumber,t->filepath);
        container(t->right,y);
    }


    void fillContainer(AD<int>* x)
    {
         container(root,x);
    }
    ...
    void insert(int x,int num,string f)
    {
        root = insert(x,num,f, root);
    }
